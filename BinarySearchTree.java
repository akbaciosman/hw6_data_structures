...
// Insert solution to programming exercise 1, section 4, chapter 6 here
   ...
   /*------------------Start Of Iterator------------------------------*/
   public static class TreeIterator<E> implements Iterator<E>{
        ...
        /**
         * 
         * @return true,if stack is not empty otherwise return false
         */  
        @Override  
        ...
        /**
         * 
         * @return if stack is not empty return next element otherwise 
         * return null;
         */
        @Override  
        public E next() {  
